 ...
 * @return {Promise}
 */
exports.sendHTTPRequest = function (method, url, payload, contentType) {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4) {
                ...
                if (status_1 < 300) {
                    ...
                    reject(new Error("Request returned a response status (" + status_1 + ")"));
...
exports.getAccountInfo = function () {
    var retrievedAccountInfo = localStorage.getItem("session_info");
    if (retrievedAccountInfo === null)
        return retrievedAccountInfo;
    else
        return JSON.parse(retrievedAccountInfo);
};
/**
 * @description Set new information about the user in Local Storage
 */
exports.updateAccountInfo = function (newInfo) {
    var existingInfo = exports.getAccountInfo();
...
exports.refreshMetadata = function () {
    var accountInfo = exports.getAccountInfo();
    if (accountInfo === null)
    ...
    return new Promise(function (resolve, reject) {
        exports
            ...
            var metadata = JSON.parse(metadataResponse).message;
            var metadataDocs = metadata.metadataDocs;
            var minicards = {};
            for (var _i = 0, _a = metadata.minicards; _i < _a.length; _i++) {
                var minicard = _a[_i];
