...
var TST = require("./TernarySearchTrie.js");
/**
...
function AutoComplete() {
    ...
    this.keysWithPrefix = function (prefix) {
        if (AutoComplete.prefixTree === null)
            return null;
    ...
    this.addPairToGraph = function (wordA, wordB, edgeWeight) {
        if (edgeWeight === void 0) { edgeWeight = 1; }
        var weight = AutoComplete.graph.getEdgeWeight(wordA, wordB) || 1;
        AutoComplete.graph.addEdge(wordA, wordB, 1 / (1 / weight + edgeWeight));
    };
    this.kNeighbors = function (words, k) {
        if (k === void 0) { k = 10; }
