...
export type CardFetchEndpoint =
  | typeof trpc.fetchCard.query
  | typeof trpc.fetchPublicCard.query;
export type CardSearchEndpoint =
  | typeof trpc.searchCards.query
  | typeof trpc.searchPublicCards.query;
...
export type MetadataNodeInformation =
  RouterOutput["publicMetadata"][0]["node_information"];

export type FetchCardEndpoint = (
  params: RouterInput["fetchCard"] | RouterInput["fetchPublicCard"],
) => Promise<RouterOutput["fetchCard"] | RouterOutput["fetchPublicCard"]>;
