 ...
 */
export function getSaltAndHash(password: string): Promise<[sjcl.BitArray, sjcl.BitArray]> {
    /**
 ...
 */
export async function getHash(password: string, salt: sjcl.BitArray): Promise<sjcl.BitArray> {
 ...
 */
export function getRandomString(stringLength: number, alphabet: string = ALPHANUMERICS) {
    let random_string = "";
