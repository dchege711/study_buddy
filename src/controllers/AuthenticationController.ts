...
import { 
    convertObjectToResponse, sendResponseFromPromise, handleServerError
 ...
 */
export function logInBySessionToken(req: Request, res: Response, next: NextFunction) {
    UserModel
        .authenticateByToken(req.cookies.sessionToken)
...
export function sendValidationEmailPost(req: Request, res: Response) {
    sendResponseFromPromise(
        UserModel.sendAccountValidationLink(req.body.emailAddress), res
    );
};
...
export function verifyAccount(req: Request, res: Response) {
    ...
    sendResponseFromPromise(
        UserModel.validateAccount(verificationURI), res
    );
};
...
export function resetPasswordPost(req: Request, res: Response) {
    sendResponseFromPromise(
        UserModel.sendResetLink(req.body.emailAddress), res
    );
};
...
export function resetPasswordLinkGet(req: Request, res: Response) {
    ...
    UserModel
        .validatePasswordResetLink(resetPasswordURI)
        .then((results) => {
            if (results.success) {
