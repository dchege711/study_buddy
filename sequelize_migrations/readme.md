...
`$ npx sequelize-cli migration:generate --name your-reason-for-the-db-change` to generate migration files.

* This generates empty migration files in the `migrations` folder.
