var CardsManager=function(t){var e={};function r(n){if(e[n])return e[n].exports;var o=e[n]={i:n,l:!1,exports:{}};return t[n].call(o.exports,o,o.exports,r),o.l=!0,o.exports}return r.m=t,r.c=e,r.d=function(t,e,n){r.o(t,e)||Object.defineProperty(t,e,{enumerable:!0,get:n})},r.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},r.t=function(t,e){if(1&e&&(t=r(t)),8&e)return t;if(4&e&&"object"==typeof t&&t&&t.__esModule)return t;var n=Object.create(null);if(r.r(n),Object.defineProperty(n,"default",{enumerable:!0,value:t}),2&e&&"string"!=typeof t)for(var o in t)r.d(n,o,function(e){return t[e]}.bind(null,o));return n},r.n=function(t){var e=t&&t.__esModule?function(){return t.default}:function(){return t};return r.d(e,"a",e),e},r.o=function(t,e){return Object.prototype.hasOwnProperty.call(t,e)},r.p="",r(r.s=2)}([function(t,e,r){"use strict";e.sendForm=function(t,r){return new Promise(function(n,o){let i=document.forms[t];if(i.checkValidity()){let t=i.elements,a={};for(let e=0;e<t.length;e++)"checkbox"==t[e].type?a[t[e].name]=t[e].checked:a[t[e].name]=t[e].value;delete a[""],e.sendHTTPRequest("POST",r,a).then(t=>{n(t)}).catch(t=>{o(t)})}else i.reportValidity(),o("Please fill in the form with valid inputs.")})},e.sendHTTPRequest=function(t,e,r,n="application/json"){return new Promise(function(o,i){let a=new XMLHttpRequest;a.onreadystatechange=function(){if(4==this.readyState){let t=this.status;t<300?o(this.response):t>=300&&t<400?(i(new Error(`Request was redirected to ${this.responseURL}.`)),window.location=this.responseURL):(i(new Error(`Request returned a response status (${t})`)),document.write(this.response))}},a.open(t,e,!0),a.setRequestHeader("Content-Type",n),a.send(JSON.stringify(r))})},e.processParams=function(){var t=new URL(document.location).searchParams;t.has("msg")&&alert(t.get("msg"))},e.getAccountInfo=function(){let t=localStorage.getItem("session_info");return null===t?t:JSON.parse(t)},e.updateAccountInfo=function(t){let r=e.getAccountInfo();null===r&&(r={}),Object.keys(t).forEach(e=>{r[e]=t[e]}),localStorage.setItem("session_info",JSON.stringify(r))},e.refreshMetadata=function(){let t=e.getAccountInfo();return null===t?Promise.resolve(null):new Promise(function(r,n){e.sendHTTPRequest("POST","/read-metadata",{userIDInApp:t.userIDInApp}).then(t=>{let e=JSON.parse(t).message,n=e.metadataDocs,o={};for(let t of e.minicards)o[t._id]={_id:t._id,title:t.title,tags:t.tags.trim().replace(/\s/g,", ")};localStorage.setItem("metadata",JSON.stringify(n)),localStorage.setItem("minicards",JSON.stringify(o)),r([n[0],o])}).catch(t=>{n(t)})})}},,function(t,e,r){"use strict";const n=r(3);var o=r(0).sendHTTPRequest;t.exports=function(t,e,r="/read-card",i={}){var a={},l=new n,u=null,c={};function s(t,e){return t.urgency<e.urgency?1:t.urgency>e.urgency?-1:t._id<e._id?1:t._id>e._id?-1:0}function f(t){return new Promise(function(n,i){let a=JSON.parse(localStorage.getItem(t));a?n(a):o("POST",r,{userIDInApp:e,cardID:t}).then(e=>{e=JSON.parse(e),localStorage.setItem(t,JSON.stringify(e.message[0])),n(e.message[0])}).catch(t=>{i(t)})})}return a.empty_card={title:"",description:"",tags:"",createdById:null,urgency:0,metadataIndex:null},a.initializeFromTags=function(e){return new Promise(function(r,o){null===e&&(e=Object.keys(t)),l=new n(s,!0),a.bst=l,u=null;let i=new Set([]);e.forEach(function(e){for(let r in t[e])!1===i.has(r)&&(a.insertCard(r,t[e][r].urgency),i.add(r))}),r()})},a.initializeFromMinicards=function(e,r=!1){return new Promise(function(o,i){l=new n(s,!0),a.bst=l,u=null;let c=new Set([]);if(e.forEach(t=>{c.add(t._id),a.insertCard(t._id,t.urgency)}),r){let r=new Set([]);e.forEach(t=>{t.tags.forEach(t=>{r.add(t)})}),r.forEach(function(e){for(let r in t[e])c.has(r)||(a.insertCard(r,t[e][r].urgency),c.add(r))})}o()})},a.initializeFromTrash=function(t){return new Promise(function(e,r){l=new n(s,!0),a.bst=l,u=null;let o=Object.keys(t);for(let e=0;e<o.length;e++)a.insertCard(o[e],t[o[e]]);e()})},a.cardKeys=function*(){let t=l.minNode();for(;t;)yield t.key,t=l.next(t);return"done"},a.fetchCard=function(t){return new Promise(function(e,r){(u=l.find(c[t]))?f(u.key._id).then(t=>{e(t)}).catch(t=>{r(t)}):e(null)})},a.next=function(){return new Promise(function(t,e){a.hasNext()?f((u=null===u?l.find(l.min()):l.next(u)).key._id).then(e=>{t(e)}).catch(t=>{e(t)}):t(null)})},a.hasNext=function(){return 0!==l.size&&(null===u||null!==l.next(u))},a.hasPrev=function(){return 0!==l.size&&null!==l.prev(u)},a.previous=function(){return new Promise(function(t,e){a.hasPrev()?f((u=l.prev(u)).key._id).then(e=>{t(e)}).catch(t=>{e(t)}):t(null)})},a.removeCard=function(t){u&&u.key._id===t&&(u=a.hasPrev()?l.prev(u):a.hasNext()?l.next(u):null);let e=c[t];return delete c[t],e&&l.remove(e),t},a.status=function(){if(u){let t=l.prev(u);t?f(t.key._id).then(t=>{console.log(`Previous: (${t.urgency}) ${t.title}`)}).catch(t=>{console.error(t)}):console.log("Previous: null"),f(u.key._id).then(t=>{console.log(`Current: (${t.urgency}) ${t.title}`)}).catch(t=>{console.error(t)}),(t=l.next(u))?f(t.key._id).then(t=>{console.log(`Next: (${t.urgency}) ${t.title}`)}).catch(t=>{console.error(t)}):console.log("Next: null")}else console.log("Current: null")},a.insertCard=function(t,e){let r={_id:t,urgency:e};c[t]=r,l.insert(r)},a.updateCard=function(t){localStorage.removeItem(t._id),localStorage.setItem(t._id,JSON.stringify(t)),i[t._id]={_id:t._id,title:t.title,tags:t.tags.trim().replace(/\s/g,", ")},c[t._id]&&a.removeCard(t._id),a.insertCard(t._id,t.urgency)},a.quartiles=function(){let t=l._size;if(0==t)return[0,0,0,0,0];if(t<=4){let t=l.min().urgency;return[t,t,t,t,t]}return[l.max().urgency,l.at(Math.floor(3*t/4)).key.urgency,l.at(Math.floor(t/2)).key.urgency,l.at(Math.floor(t/4)).key.urgency,l.min().urgency]},a.saveCard=function(t,e){return new Promise(function(r,n){o("POST",e,t).then(t=>{(t=JSON.parse(t)).success?(a.updateCard(t.message),r(t.message)):n(t.message)}).catch(t=>{n(t)})})},a}},function(t,e,r){
/**
 * avl v1.4.4
